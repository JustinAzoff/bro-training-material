...
event http_all_headers(c: connection, is_orig: bool, hlist: mime_header_list)
    ...
    # TODO: Write code that keeps track of the user agent per session cookie.
    # This will involve two if-statements:
    #   1) Check whether we track the current cookie already
    #   2) If we track the current session cookie, does the associated user
    #      agent match the current one?

    # FIXME: replace this return statement with your code.
    return;
